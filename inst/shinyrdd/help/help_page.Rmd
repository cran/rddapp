...
The mechanism is described by (a series) of "if" statements, in the **Treatment design** panel, under the heading **Assign treatment if**. The user selects the **_assignment_ variable** in the drop-down menu labeled **primary assignment**. The box underneath is used to input the threshold for being assigned to the treatment. 
...
# About
This software was developed by [Felix Thoemmes](https://psychology.cornell.edu/felix-j-thoemmes), [Wang Liao](https://wliao229.github.io/), [Ze Jin](https://www.linkedin.com/in/ze-jin-08045b31), [Wenyu Zhang](http://zwenyu.github.io/), [Irena Papst](https://github.com/papsti), and [Kim Hochstedler](https://kimhochstedler.github.io/my_website/) all at Cornell University. We are happy to receive feedback! Please send it to
![](../www/fjt_email.png)
